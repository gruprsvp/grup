...
mixin _$LocaleState implements DiagnosticableTreeMixin {
 ...
 String get languageCode; String? get scriptCode; String? get countryCode;
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String languageCode,  String? scriptCode,  String? countryCode)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _LocaleState() when $default != null:
return $default(_that.languageCode,_that.scriptCode,_that.countryCode);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String languageCode,  String? scriptCode,  String? countryCode)  $default,) {final _that = this;
switch (_that) {
case _LocaleState():
return $default(_that.languageCode,_that.scriptCode,_that.countryCode);}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String languageCode,  String? scriptCode,  String? countryCode)?  $default,) {final _that = this;
switch (_that) {
case _LocaleState() when $default != null:
return $default(_that.languageCode,_that.scriptCode,_that.countryCode);case _:
  return null;
...
class _LocaleState with DiagnosticableTreeMixin implements LocaleState {
  const _LocaleState({required this.languageCode, this.scriptCode, this.countryCode});
...
/// Create a copy of LocaleState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? languageCode = null,Object? scriptCode = freezed,Object? countryCode = freezed,}) {
