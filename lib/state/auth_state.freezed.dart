...
mixin _$AuthState implements DiagnosticableTreeMixin {
 ...
 AuthStatus get status;@UserJsonConverter() User? get user; String? get lastRoute;
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( AuthStatus status, @UserJsonConverter()  User? user,  String? lastRoute)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _AuthState() when $default != null:
return $default(_that.status,_that.user,_that.lastRoute);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( AuthStatus status, @UserJsonConverter()  User? user,  String? lastRoute)  $default,) {final _that = this;
switch (_that) {
case _AuthState():
return $default(_that.status,_that.user,_that.lastRoute);}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( AuthStatus status, @UserJsonConverter()  User? user,  String? lastRoute)?  $default,) {final _that = this;
switch (_that) {
case _AuthState() when $default != null:
return $default(_that.status,_that.user,_that.lastRoute);case _:
  return null;
...
class _AuthState with DiagnosticableTreeMixin implements AuthState {
  const _AuthState({required this.status, @UserJsonConverter() this.user, this.lastRoute});
...
/// Create a copy of AuthState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? status = null,Object? user = freezed,Object? lastRoute = freezed,}) {
