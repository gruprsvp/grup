...
mixin _$Invite implements DiagnosticableTreeMixin {
 ...
 String get id; String get memberId; InviteMethods get method; String get value; DateTime? get createdAt; DateTime? get updatedAt;
...
@useResult
$Res call({
 String id, String memberId, InviteMethods method, String value, DateTime? createdAt, DateTime? updatedAt
});
...
as InviteMethods,value: null == value ? _self.value : value // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String memberId,  InviteMethods method,  String value,  DateTime? createdAt,  DateTime? updatedAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Invite() when $default != null:
return $default(_that.id,_that.memberId,_that.method,_that.value,_that.createdAt,_that.updatedAt);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String memberId,  InviteMethods method,  String value,  DateTime? createdAt,  DateTime? updatedAt)  $default,) {final _that = this;
switch (_that) {
case _Invite():
return $default(_that.id,_that.memberId,_that.method,_that.value,_that.createdAt,_that.updatedAt);}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String memberId,  InviteMethods method,  String value,  DateTime? createdAt,  DateTime? updatedAt)?  $default,) {final _that = this;
switch (_that) {
case _Invite() when $default != null:
return $default(_that.id,_that.memberId,_that.method,_that.value,_that.createdAt,_that.updatedAt);case _:
  return null;
...
class _Invite with DiagnosticableTreeMixin implements Invite {
  const _Invite({required this.id, required this.memberId, required this.method, required this.value, this.createdAt, this.updatedAt});
  factory _Invite.fromJson(Map<String, dynamic> json) => _$InviteFromJson(json);

@override final  String id;
@override final  String memberId;
@override final  InviteMethods method;
...
/// Create a copy of Invite
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? memberId = null,Object? method = null,Object? value = null,Object? createdAt = freezed,Object? updatedAt = freezed,}) {
