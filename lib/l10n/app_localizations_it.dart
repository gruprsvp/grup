...
class AppLocalizationsIt extends AppLocalizations {
  ...
  @override
  String get contactsPermissionMessage => 'Per invitare i tuoi amici ai gruppi, devi darci accesso ai tuoi contatti';
  ...
  @override
  String get defaultRulesDescription => 'Scegli una risposta predefinita per questo evento';

  @override
  String get defaultRulesDaily => 'Giornaliero';

  @override
  String get defaultRulesExplanation => 'Le risposte predefinite ti permettono di impostare risposte automatiche per eventi ricorrenti. Puoi scegliere tra opzioni giornaliere, nei giorni feriali o nei fine settimana.';
  ...
  @override
  String get deleteGroupConfirmation => 'Sei sicuro di voler eliminare questo gruppo?';

  @override
  String get deleteProfile => 'Elimina il profilo';

  @override
  String get deleteProfileConfirmation => 'Sei sicuro di voler eliminare il tuo profilo?';

  @override
  String get deleteSchedule => 'Elimina evento';

  @override
  String get deleteScheduleConfirmation => 'Sei sicuro di voler eliminare questo evento?';

  @override
  String get details => 'Dettagli';

  @override
  String get enterGroupDescription => 'Puoi inserire una descrizione del gruppo se vuoi';
  ...
  @override
  String get eventsEmpty => 'È il momento di dare vita al tuo gruppo!<br/>Tocca il pulsante <newevent/> per pianificare la tua prima attività.<br/>Scegli una data, imposta un orario e aggiungi dettagli per far sì che tutti siano entusiasti di riunirsi.';
  ...
  @override
  String get feedbackEmailBody => 'Ciao team GRUP,\n\nHo un feedback per voi:\n\n';

  @override
  String get feedbackPromptTitle => 'Come stiamo andando?';

  @override
  String get feedbackPromptBody => 'Se ti piace <title>GRUP</title>, lasciaci una recensione positiva per raggiungere più persone!\nSe hai qualche feedback, faccelo sapere così possiamo migliorare.';
  ...
  @override
  String get groupDismissAdminConfirmation => 'Sei sicuro di voler rimuovere questo membro come amministratore?';

  @override
  String get groupEmptyEventsAdmin => 'Il tuo calendario eventi è vuoto.<br/>Pronto a pianificare qualcosa di emozionante? Tocca il pulsante <manage/> per creare un nuovo evento e invitare i membri del gruppo!';

  @override
  String get groupEmptyEventsUser => 'Non ci sono eventi per questo giorno specifico, controlla un\'altra data!';

  @override
  String get groupLeave => 'Lascia il gruppo';

  @override
  String get groupLeaveConfirmation => 'Sei sicuro di voler lasciare questo gruppo? Perderai l\'accesso a tutti gli eventi e ai membri del gruppo.';

  @override
  String get groupMakeAdmin => 'Rendi amministratore del gruppo';

  @override
  String get groupMakeAdminConfirmation => 'Sei sicuro di voler rendere questo membro amministratore?';
  ...
  @override
  String get groupRemoveConfirmation => 'Sei sicuro di voler rimuovere questo membro dal gruppo?';
  ...
  @override
  String get invitesEmpty => 'Non hai ancora inviti.<br/>Tocca il pulsante <invite/> per iniziare a invitare i tuoi amici a unirsi al gruppo.';
  ...
  @override
  String get onboardingMessage => 'Benvenuto in <title>GRUP</title>!<br/>Non hai ancora creato gruppi. Inizia toccando il pulsante <plus/> per creare il tuo primo gruppo e inizia a organizzare eventi con amici, familiari o colleghi.';
