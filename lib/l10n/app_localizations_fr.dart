...
class AppLocalizationsFr extends AppLocalizations {
  ...
  @override
  String get contactsPermissionMessage => 'Pour inviter tes amis à des groupes, tu dois nous donner accès à tes contacts';
  ...
  @override
  String get defaultRulesDescription => 'Choisis une réponse par défaut pour cet événement';

  @override
  String get defaultRulesDaily => 'Quotidien';

  @override
  String get defaultRulesExplanation => 'Les réponses par défaut te permettent de définir des réponses automatiques pour les événements récurrents. Tu peux choisir entre des options quotidiennes, en semaine ou le week-end.';
  ...
  @override
  String get deleteGroupConfirmation => 'Es-tu sûr de vouloir supprimer ce groupe?';

  @override
  String get deleteProfile => 'Supprime le profil';

  @override
  String get deleteProfileConfirmation => 'Es-tu sûr de vouloir supprimer ton profil?';

  @override
  String get deleteSchedule => 'Supprime l\'événement';

  @override
  String get deleteScheduleConfirmation => 'Es-tu sûr de vouloir supprimer cet événement?';

  @override
  String get details => 'Détails';

  @override
  String get enterGroupDescription => 'Tu peux entrer une description de groupe si tu veux';
  ...
  @override
  String get eventsEmpty => 'Il est temps de donner vie à ton groupe!<br/>Appuie sur le bouton <newevent/> pour planifier ta première activité.<br/>Choisis une date, définis une heure et ajoute des détails pour que tout le monde soit excité de se retrouver.';
  ...
  @override
  String get groupDismissAdminConfirmation => 'Es-tu sûr de vouloir révoquer ce membre comme admin?';

  @override
  String get groupEmptyEventsAdmin => 'Ton calendrier d\'événements est vide.<br/>Prêt à planifier quelque chose d\'excitant? Appuie sur le bouton <manage/> pour créer un nouvel événement et inviter les membres du groupe!';

  @override
  String get groupEmptyEventsUser => 'Il n\'y a pas d\'événements pour ce jour spécifique, vérifie une autre date!';

  @override
  String get groupLeave => 'Quitte le groupe';

  @override
  String get groupLeaveConfirmation => 'Es-tu sûr de vouloir quitter ce groupe? Tu perdras l\'accès à tous les événements et membres du groupe.';

  @override
  String get groupMakeAdmin => 'Rend admin du groupe';

  @override
  String get groupMakeAdminConfirmation => 'Es-tu sûr de vouloir rendre ce membre admin?';
  ...
  @override
  String get groupRemoveConfirmation => 'Es-tu sûr de vouloir retirer ce membre du groupe?';
  ...
  @override
  String get invitesEmpty => 'Il est temps d\'inviter tes amis à rejoindre tes groupes!<br/>Appuie sur le bouton <invite/> pour inviter tes amis à rejoindre tes groupes et commencer à organiser des événements ensemble.';
  ...
  @override
  String get onboardingMessage => 'Bienvenue sur <title>GRUP</title>!<br/>Tu n\'as pas encore créé de groupes. Commence en appuyant sur le bouton <plus/> pour créer ton premier groupe et commence à organiser des événements avec des amis, de la famille ou des collègues.';
