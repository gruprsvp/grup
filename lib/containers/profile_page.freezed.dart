...
mixin _$ViewModel {
  ...
  OnSaveCallback get onSave => throw _privateConstructorUsedError;
...
abstract class _$ViewModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({Profile? profile, OnSaveCallback onSave});
...
abstract class __ViewModel implements _ViewModel {
  const factory __ViewModel(
      {final Profile? profile,
      required final OnSaveCallback onSave}) = _$_ViewModelImpl;

  @override
  Profile? get profile;
  @override
  OnSaveCallback get onSave;
  @override
  @JsonKey(ignore: true)
  _$$_ViewModelImplCopyWith<_$_ViewModelImpl> get copyWith =>
      throw _privateConstructorUsedError;
