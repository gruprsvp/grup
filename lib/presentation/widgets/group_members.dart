...
class GroupMembers extends StatelessWidget {
  ...
  const GroupMembers({super.key, this.members, this.onInvite});
  ...
  Future<List<ContactInvite>?> _inviteEmailDialog(BuildContext context) =>
      _showContactDialog(context: context, showEmail: true, showPhone: false);

  Future<List<ContactInvite>?> _invitePhoneDialog(BuildContext context) =>
      _showContactDialog(context: context, showEmail: false, showPhone: true);

  Future<List<ContactInvite>?> _inviteGuestDialog(BuildContext context) =>
      _showContactDialog(context: context, showEmail: false, showPhone: false);
