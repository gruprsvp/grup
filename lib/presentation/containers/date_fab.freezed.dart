...
mixin _$ViewModel {
 ...
 DateTime get selectedDate; ValueChanged<DateTime> get onDateChanged;
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( DateTime selectedDate,  ValueChanged<DateTime> onDateChanged)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case __ViewModel() when $default != null:
return $default(_that.selectedDate,_that.onDateChanged);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( DateTime selectedDate,  ValueChanged<DateTime> onDateChanged)  $default,) {final _that = this;
switch (_that) {
case __ViewModel():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( DateTime selectedDate,  ValueChanged<DateTime> onDateChanged)?  $default,) {final _that = this;
switch (_that) {
case __ViewModel() when $default != null:
return $default(_that.selectedDate,_that.onDateChanged);case _:
  return null;
...
/// Create a copy of _ViewModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? selectedDate = null,Object? onDateChanged = null,}) {
