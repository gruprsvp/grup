...
mixin _$ViewModel implements DiagnosticableTreeMixin {
 ...
 Profile? get profile; OnProfileSaveCallback get onSave;
...
@useResult
$Res call({
 Profile? profile, OnProfileSaveCallback onSave
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( Profile? profile,  OnProfileSaveCallback onSave)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case __ViewModel() when $default != null:
return $default(_that.profile,_that.onSave);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( Profile? profile,  OnProfileSaveCallback onSave)  $default,) {final _that = this;
switch (_that) {
case __ViewModel():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( Profile? profile,  OnProfileSaveCallback onSave)?  $default,) {final _that = this;
switch (_that) {
case __ViewModel() when $default != null:
return $default(_that.profile,_that.onSave);case _:
  return null;
...
@override final  OnProfileSaveCallback onSave;
...
/// Create a copy of _ViewModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? profile = freezed,Object? onSave = null,}) {
