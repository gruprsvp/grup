...
mixin _$ViewModel implements DiagnosticableTreeMixin {
 ...
 ValueChanged<DateTime> get onDateChanged; bool get isAdmin; DateTime? get selectedDate; Iterable<ScheduleInstanceSummary>? get schedules; OnReplyChangedCallback? get onReplyChanged;
...
@useResult
$Res call({
 ValueChanged<DateTime> onDateChanged, bool isAdmin, DateTime? selectedDate, Iterable<ScheduleInstanceSummary>? schedules, OnReplyChangedCallback? onReplyChanged
});
...
as Iterable<ScheduleInstanceSummary>?,onReplyChanged: freezed == onReplyChanged ? _self.onReplyChanged : onReplyChanged // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( ValueChanged<DateTime> onDateChanged,  bool isAdmin,  DateTime? selectedDate,  Iterable<ScheduleInstanceSummary>? schedules,  OnReplyChangedCallback? onReplyChanged)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case __ViewModel() when $default != null:
return $default(_that.onDateChanged,_that.isAdmin,_that.selectedDate,_that.schedules,_that.onReplyChanged);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( ValueChanged<DateTime> onDateChanged,  bool isAdmin,  DateTime? selectedDate,  Iterable<ScheduleInstanceSummary>? schedules,  OnReplyChangedCallback? onReplyChanged)  $default,) {final _that = this;
switch (_that) {
case __ViewModel():
return $default(_that.onDateChanged,_that.isAdmin,_that.selectedDate,_that.schedules,_that.onReplyChanged);}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( ValueChanged<DateTime> onDateChanged,  bool isAdmin,  DateTime? selectedDate,  Iterable<ScheduleInstanceSummary>? schedules,  OnReplyChangedCallback? onReplyChanged)?  $default,) {final _that = this;
switch (_that) {
case __ViewModel() when $default != null:
return $default(_that.onDateChanged,_that.isAdmin,_that.selectedDate,_that.schedules,_that.onReplyChanged);case _:
  return null;
...
class __ViewModel with DiagnosticableTreeMixin implements _ViewModel {
  const __ViewModel({required this.onDateChanged, required this.isAdmin, this.selectedDate, this.schedules, this.onReplyChanged});
  

@override final  ValueChanged<DateTime> onDateChanged;
@override final  bool isAdmin;
@override final  DateTime? selectedDate;
@override final  Iterable<ScheduleInstanceSummary>? schedules;
@override final  OnReplyChangedCallback? onReplyChanged;
...
/// Create a copy of _ViewModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? onDateChanged = null,Object? isAdmin = null,Object? selectedDate = freezed,Object? schedules = freezed,Object? onReplyChanged = freezed,}) {
