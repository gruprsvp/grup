...
mixin _$ViewModel {
 ...
 bool get loading; Group? get group; Iterable<Schedule>? get schedules; ValueSetter<Schedule>? get onScheduleCreate; ValueSetter<Schedule>? get onScheduleDelete; Future<RruleL10n>? get rrulel10n;
...
@useResult
$Res call({
 bool loading, Group? group, Iterable<Schedule>? schedules, ValueSetter<Schedule>? onScheduleCreate, ValueSetter<Schedule>? onScheduleDelete, Future<RruleL10n>? rrulel10n
});
...
as Iterable<Schedule>?,onScheduleCreate: freezed == onScheduleCreate ? _self.onScheduleCreate : onScheduleCreate // ignore: cast_nullable_to_non_nullable
as ValueSetter<Schedule>?,onScheduleDelete: freezed == onScheduleDelete ? _self.onScheduleDelete : onScheduleDelete // ignore: cast_nullable_to_non_nullable
as ValueSetter<Schedule>?,rrulel10n: freezed == rrulel10n ? _self.rrulel10n : rrulel10n // ignore: cast_nullable_to_non_nullable
as Future<RruleL10n>?,
  ));
}
/// Create a copy of _ViewModel
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( bool loading,  Group? group,  Iterable<Schedule>? schedules,  ValueSetter<Schedule>? onScheduleCreate,  ValueSetter<Schedule>? onScheduleDelete,  Future<RruleL10n>? rrulel10n)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case __ViewModel() when $default != null:
return $default(_that.loading,_that.group,_that.schedules,_that.onScheduleCreate,_that.onScheduleDelete,_that.rrulel10n);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( bool loading,  Group? group,  Iterable<Schedule>? schedules,  ValueSetter<Schedule>? onScheduleCreate,  ValueSetter<Schedule>? onScheduleDelete,  Future<RruleL10n>? rrulel10n)  $default,) {final _that = this;
switch (_that) {
case __ViewModel():
return $default(_that.loading,_that.group,_that.schedules,_that.onScheduleCreate,_that.onScheduleDelete,_that.rrulel10n);}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( bool loading,  Group? group,  Iterable<Schedule>? schedules,  ValueSetter<Schedule>? onScheduleCreate,  ValueSetter<Schedule>? onScheduleDelete,  Future<RruleL10n>? rrulel10n)?  $default,) {final _that = this;
switch (_that) {
case __ViewModel() when $default != null:
return $default(_that.loading,_that.group,_that.schedules,_that.onScheduleCreate,_that.onScheduleDelete,_that.rrulel10n);case _:
  return null;
...
class __ViewModel implements _ViewModel {
  const __ViewModel({required this.loading, this.group, this.schedules, this.onScheduleCreate, this.onScheduleDelete, this.rrulel10n});
  

@override final  bool loading;
@override final  Group? group;
@override final  Iterable<Schedule>? schedules;
@override final  ValueSetter<Schedule>? onScheduleCreate;
@override final  ValueSetter<Schedule>? onScheduleDelete;
@override final  Future<RruleL10n>? rrulel10n;
...
/// Create a copy of _ViewModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? loading = null,Object? group = freezed,Object? schedules = freezed,Object? onScheduleCreate = freezed,Object? onScheduleDelete = freezed,Object? rrulel10n = freezed,}) {
