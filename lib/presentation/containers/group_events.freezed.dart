...
extension _ViewModelPatterns on _ViewModel {
  ...
  TResult maybeWhen<TResult extends Object?>(
    ...
    switch (_that) {
      case __ViewModel() when $default != null:
        return $default(_that.loading, _that.group, _that.schedules,
            _that.onScheduleCreate, _that.onScheduleDelete, _that.rrulel10n);
      case _:
        return orElse();
    }
  }
