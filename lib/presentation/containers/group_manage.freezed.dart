...
mixin _$ViewModel implements DiagnosticableTreeMixin {
 ...
 bool get loading; Group? get group; ValueSetter<String> get onDelete;
...
@useResult
$Res call({
 bool loading, Group? group, ValueSetter<String> onDelete
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( bool loading,  Group? group,  ValueSetter<String> onDelete)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case __ViewModel() when $default != null:
return $default(_that.loading,_that.group,_that.onDelete);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( bool loading,  Group? group,  ValueSetter<String> onDelete)  $default,) {final _that = this;
switch (_that) {
case __ViewModel():
return $default(_that.loading,_that.group,_that.onDelete);}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( bool loading,  Group? group,  ValueSetter<String> onDelete)?  $default,) {final _that = this;
switch (_that) {
case __ViewModel() when $default != null:
return $default(_that.loading,_that.group,_that.onDelete);case _:
  return null;
...
class __ViewModel with DiagnosticableTreeMixin implements _ViewModel {
  const __ViewModel({required this.loading, this.group, required this.onDelete});
  

@override final  bool loading;
@override final  Group? group;
@override final  ValueSetter<String> onDelete;
...
/// Create a copy of _ViewModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? loading = null,Object? group = freezed,Object? onDelete = null,}) {
