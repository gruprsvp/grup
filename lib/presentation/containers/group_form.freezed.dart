...
mixin _$ViewModel implements DiagnosticableTreeMixin {
 ...
 bool get loading; OnGroupSaveCallback get onSave; Group? get group;
...
void debugFillProperties(DiagnosticPropertiesBuilder properties) {
  properties
    ...
    ..add(DiagnosticsProperty('loading', loading))..add(DiagnosticsProperty('onSave', onSave))..add(DiagnosticsProperty('group', group));
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _ViewModel&&(identical(other.loading, loading) || other.loading == loading)&&(identical(other.onSave, onSave) || other.onSave == onSave)&&(identical(other.group, group) || other.group == group));
}
...
@useResult
$Res call({
 bool loading, OnGroupSaveCallback onSave, Group? group
});
...
/// Create a copy of _ViewModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? loading = null,Object? onSave = null,Object? group = freezed,}) {
  return _then(_self.copyWith(
loading: null == loading ? _self.loading : loading // ignore: cast_nullable_to_non_nullable
as bool,onSave: null == onSave ? _self.onSave : onSave // ignore: cast_nullable_to_non_nullable
as OnGroupSaveCallback,group: freezed == group ? _self.group : group // ignore: cast_nullable_to_non_nullable
as Group?,
  ));
}
/// Create a copy of _ViewModel
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( bool loading,  OnGroupSaveCallback onSave,  Group? group)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case __ViewModel() when $default != null:
return $default(_that.loading,_that.onSave,_that.group);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( bool loading,  OnGroupSaveCallback onSave,  Group? group)  $default,) {final _that = this;
switch (_that) {
case __ViewModel():
return $default(_that.loading,_that.onSave,_that.group);}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( bool loading,  OnGroupSaveCallback onSave,  Group? group)?  $default,) {final _that = this;
switch (_that) {
case __ViewModel() when $default != null:
return $default(_that.loading,_that.onSave,_that.group);case _:
  return null;
...
class __ViewModel with DiagnosticableTreeMixin implements _ViewModel {
  const __ViewModel({required this.loading, required this.onSave, this.group});
  

@override final  bool loading;
@override final  OnGroupSaveCallback onSave;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is __ViewModel&&(identical(other.loading, loading) || other.loading == loading)&&(identical(other.onSave, onSave) || other.onSave == onSave)&&(identical(other.group, group) || other.group == group));
}
...
/// Create a copy of _ViewModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? loading = null,Object? onSave = null,Object? group = freezed,}) {
