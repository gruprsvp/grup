...
Future<DefaultRule> _$DefaultRuleFromSupabase(
...
Future<Map<String, dynamic>> _$DefaultRuleToSupabase(
  DefaultRule instance, {
  required SupabaseProvider provider,
  OfflineFirstWithSupabaseRepository? repository,
}) async {
  return {
...
Future<DefaultRule> _$DefaultRuleFromSqlite(
  Map<String, dynamic> data, {
...
Future<Map<String, dynamic>> _$DefaultRuleToSqlite(
  DefaultRule instance, {
  required SqliteProvider provider,
  OfflineFirstWithSupabaseRepository? repository,
}) async {
...
class DefaultRuleAdapter extends OfflineFirstWithSupabaseAdapter<DefaultRule> {
  ...
  Future<int?> primaryKeyByUniqueColumns(
    ...
    final results = await executor.rawQuery(
      '''
        SELECT * FROM `DefaultRule` WHERE id = ? LIMIT 1''',
      [instance.id],
    );
  ...
  @override
  Future<DefaultRule> fromSupabase(
    Map<String, dynamic> input, {
    required provider,
    covariant OfflineFirstWithSupabaseRepository? repository,
  }) async => await _$DefaultRuleFromSupabase(
    input,
    provider: provider,
    repository: repository,
  );
  ...
  Future<Map<String, dynamic>> toSupabase(
    ...
    required provider,
    covariant OfflineFirstWithSupabaseRepository? repository,
  }) async => await _$DefaultRuleToSupabase(
    input,
    provider: provider,
    repository: repository,
  );
  @override
  Future<DefaultRule> fromSqlite(
    Map<String, dynamic> input, {
    required provider,
    covariant OfflineFirstWithSupabaseRepository? repository,
  }) async => await _$DefaultRuleFromSqlite(
    input,
    provider: provider,
    repository: repository,
  );
  ...
  Future<Map<String, dynamic>> toSqlite(
    ...
    required provider,
    covariant OfflineFirstWithSupabaseRepository? repository,
  }) async => await _$DefaultRuleToSqlite(
    input,
    provider: provider,
    repository: repository,
  );
