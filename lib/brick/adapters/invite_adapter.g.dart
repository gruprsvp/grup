...
Future<Invite> _$InviteFromSupabase(
...
Future<Map<String, dynamic>> _$InviteToSupabase(
  Invite instance, {
  required SupabaseProvider provider,
  OfflineFirstWithSupabaseRepository? repository,
}) async {
...
Future<Invite> _$InviteFromSqlite(
  Map<String, dynamic> data, {
...
Future<Map<String, dynamic>> _$InviteToSqlite(
  Invite instance, {
  required SqliteProvider provider,
  OfflineFirstWithSupabaseRepository? repository,
}) async {
...
class InviteAdapter extends OfflineFirstWithSupabaseAdapter<Invite> {
  ...
  Future<int?> primaryKeyByUniqueColumns(
    ...
    final results = await executor.rawQuery(
      '''
        SELECT * FROM `Invite` WHERE id = ? LIMIT 1''',
      [instance.id],
    );
  ...
  @override
  Future<Invite> fromSupabase(
    Map<String, dynamic> input, {
    required provider,
    covariant OfflineFirstWithSupabaseRepository? repository,
  }) async => await _$InviteFromSupabase(
    input,
    provider: provider,
    repository: repository,
  );
  ...
  Future<Map<String, dynamic>> toSupabase(
    ...
    required provider,
    covariant OfflineFirstWithSupabaseRepository? repository,
  }) async => await _$InviteToSupabase(
    input,
    provider: provider,
    repository: repository,
  );
  @override
  Future<Invite> fromSqlite(
    Map<String, dynamic> input, {
    required provider,
    covariant OfflineFirstWithSupabaseRepository? repository,
  }) async => await _$InviteFromSqlite(
    input,
    provider: provider,
    repository: repository,
  );
